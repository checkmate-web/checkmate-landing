  ...
  return (
    <section className="py-32 relative bag-gradient-to-b from-[#0a0a0f] to-[#0d1117]">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-blue-800/5 rounded-full blur-3xl"></div>
      </div>
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-light mt-4 mb-4">
            Our <span className="text-blue-800 font-medium">Partners</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="group" style={{ opacity: 1, transform: "none" }}>
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] hover:border-blue-800/30 transition-all duration-500">
              <div className="relative aspect-[4/5] overflow-hidden">
                ...
                {/* <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-blue-800/20 backdrop-blur-sm border border-blue-800/30">
