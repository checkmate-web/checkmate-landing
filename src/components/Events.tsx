      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="mb-16" style={{ opacity: 1, transform: "none" }}>
          ...
          <h2 className="text-4xl md:text-5xl font-light mt-4">
            Types of <span className="text-blue-800 font-medium">Events</span>
          </h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="p-8 rounded-2xl border border-white/10 bg-[#0a0a0f]/80 backdrop-blur-sm hover:border-blue-800/30 transition-all duration-500 h-full">
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-blue-800/20 blur-xl rounded-full scale-150 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-blue-800/20 to-blue-900/20 flex items-center justify-center">
                  <svg
                    ...
                    className="lucide lucide-building w-6 h-6 text-blue-800"
                  >
                    <rect
                      width="16"
                      height="20"
              ...
              <h3 className="text-xl font-medium mb-3 group-hover:text-blue-800 transition-colors">
                Corporate Event
              </h3>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-800 to-blue-900 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
            </div>
          </div>
          <div
            className="group relative overflow-hidden"
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-blue-800/20 to-blue-900/20 flex items-center justify-center">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-music4 w-6 h-6 text-blue-800"
                  >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-blue-800/20 to-blue-900/20 flex items-center justify-center">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-calendar w-6 h-6 text-blue-800"
                  >
                    <path d="M8 2v4"></path>
                    <path d="M16 2v4"></path>
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-blue-800/20 to-blue-900/20 flex items-center justify-center">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-users w-6 h-6 text-blue-800"
                  >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-blue-800/20 to-blue-900/20 flex items-center justify-center">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-flag w-6 h-6 text-blue-800"
                  >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-blue-800/20 to-blue-900/20 flex items-center justify-center">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-briefcase w-6 h-6 text-blue-800"
                  >
